...
# App "5. Membros" at local TM workspaces
# @author Marcus Vinicius de Carvalho <marcus.carvalho@aiesec.net>
class App5Membros < PodioAppControl
	...
	# Getter for  of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String]  of the member
	def sexo(index)
		i = get_field_index_by_external_id(index, @fields[:sexo])
		$enum_sexo.key(fields(index, i)['id'].to_i) unless i.nil?
	end

	# Setter for sex of the member
	# @param param [String] The value you want to set
	# @return [Integer] Category Sex id of the member
	def sexo=(param)
	...
	# Setter for data_nascimento of the member
	# @param param [String] The value you want to set
	def data_nascimento=(param)
		@data_nascimento = param.strftime('%Y-%m-%d %H:%M:%S')
	end

	# Setter for data_nascimento date format of the member
	# @param year [Integer] 
	# @param month [Integer] 
	# @param day [Integer] 
	# @param hour [Integer] 
	...
	# Getter for celular of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String] Celphone of the member
	def celular(index)
		i = get_field_index_by_external_id(index, @fields[:celular])
		fields(index, i).to_s.gsub(/[^0-9]/,'') unless i.nil?
	end

	# Setter for celular of the member
	# @param param [String] The value you want to set
	def celular=(param)
		param.gsub!(/[^0-9]/,'')
		@celular = param
	...
	# Getter for operadora of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of company phone of the member
	def operadora(index)
		i = get_field_index_by_external_id(index, @fields[:operadora])
		$enum_operadora.key(fields(index, i)['id'].to_i) unless i.nil?
	end

	# Setter for operadora of the member
	# @param param [Integer] The value you want to set
	def operadora=(param)
		@operadora = $enum_operadora[param]
	end

	# Getter for emails of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Array] List of hashs emails of the members
	def emails(index)
		i = get_field_index_by_external_id(index, @fields[:email])
		values(index, i) unless i.nil?
	end

	# Setter for emails of the member
	# @param param [Array] The values you want to set
	def emails=(param)
		@emails = param
	end

	# Getter for email_text of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String] Old Email of the member
	def email_text(index)
		i = get_field_index_by_external_id(index, @fields[:email_old])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for email_text of the member
	# @param param [String] The value you want to set
	def email_text=(param)
		@email_text = param
	end

	# Getter for endereco of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String] Street of the member
	def endereco(index)
		i = get_field_index_by_external_id(index, @fields[:endereco])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for endereco of the member
	# @param param [String] The value you want to set
	def endereco=(param)
		@endereco = param
	end

	# Getter for cep of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] CEP of the member
	def cep(index)
		i = get_field_index_by_external_id(index, @fields[:cep])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for cep of the member
	# @param param [String] The value you want to set
	def cep=(param)
		@cep = param
	end

	# Getter for cidade of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String] City of the member
	def cidade(index)
		i = get_field_index_by_external_id(index, @fields[:cidade])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for cidade of the member
	# @param param [String] The value you want to set
	def cidade=(param)
		@cidade = param
	end

	# Getter for estado_id of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Id of referene of state of the member
	def estado_id(index)
		i = get_field_index_by_external_id(index, @fields[:estado])
		fields(index, i)['item_id'].to_i unless i.nil?
	end

	# Setter for estado_id of the member
	# @param param [Integer] The value you want to set
	def estado_id=(param)
		@estado = param
	end

	# Getter for formacao of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of formacao of the member
	def formacao(index)
		i = get_field_index_by_external_id(index, @fields[:formacao])
		$enum_formacao.key(fields(index, i)['id'].to_i) unless i.nil?
	end

	# Setter for formacao of the member
	# @param param [Integer] The value you want to set
	def formacao=(param)
		@formacao = $enum_formacao[param]
	end

	# Getter for curso of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String] Course of the member
	def curso(index)
		i = get_field_index_by_external_id(index, @fields[:curso])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for curso of the member
	# @param param [String] The value you want to set
	def curso=(param)
		@curso = param
	end
	...
	# Getter for  of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of faculdade of the member
	def semestre(index)
		i = get_field_index_by_external_id(index, @fields[:semestre])
		$enum_semestre.key(fields(index, i)['id'].to_i) unless i.nil?
	end

	# Setter for semestre of the member
	# @param param [Integer] The value you want to set
	def semestre=(param)
		@semestre = $enum_semestre[param]
	end

	# Getter for faculdade of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String] Name of faculdade of the member
	def faculdade(index)
		i = get_field_index_by_external_id(index, @fields[:faculdade])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for faculdade of the member
	# @param param [String] The value you want to set
	def faculdade=(param)
		@faculdade = param
	end

	# Getter for ingles of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of ingles of the member
	def ingles(index)
		i = get_field_index_by_external_id(index, @fields[:ingles])
		$enum_lingua.key(fields(index, i)['id'].to_i) unless i.nil?
	end

	# Setter for ingles of the member
	# @param param [Integer] The value you want to set
	def ingles=(param)
		@ingles = $enum_lingua[param]
	end

	# Getter for espanhol of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of espanhol of the member
	def espanhol(index)
		i = get_field_index_by_external_id(index, @fields[:espanhol])
		$enum_lingua.key(fields(index, i)['id'].to_i) unless i.nil?
	end

	# Setter for espanhol of the member
	# @param param [Integer] The value you want to set
	def espanhol=(param)
		@espanhol = $enum_lingua[param]
	end

	# Getter for entidade_id of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Id of referene of entity of the member
	def entidade_id(index)
		i = get_field_index_by_external_id(index, @fields[:entidade])
		fields(index, i)['item_id'].to_i unless i.nil?
	end

	# Setter for entidade_id of the member
	# @param param [Integer] The value you want to set
	def entidade=(param)
		@entidade = param
	end

	# Getter for turno of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of turno of the member
	def turno(index)
		i = get_field_index_by_external_id(index, @fields[:turno])
		$enum_turno.key(fields(index, i)['id'].to_i) unless i.nil?
	end

	# Setter for turno of the member
	# @param param [Integer] The value you want to set
	def turno=(param)
		@turno = $enum_turno[param]
	end

	# Getter for programa_interesse of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of programa_interesse of the member
	...
	# Setter for programa_interesse of the member
	# @param param [Integer] The value you want to set
	def programa_interesse=(param)
		@programa_interesse = $enum_programa[param]
	end

	# Getter for conheceu_aiesec of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of conheceu_aiesec of the member
	...
	# Setter for conheceu_aiesec of the member
	# @param param [Integer] The value you want to set
	def conheceu_aiesec=(param)
		@conheceu_aiesec = $enum_conheceu[param]
	end

	# Getter for pessoa_que_indicou of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [String] Name of the member that indicate
	def pessoa_que_indicou(index)
		i = get_field_index_by_external_id(index, @fields[:pessoa_que_indicou])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for pessoa_que_indicou of the member
	# @param param [String] The value you want to set
	def pessoa_que_indicou=(param)
		@pessoa_que_indicou = param
	end

	# Getter for voluntario_ferias of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Boolean] If member was just for summer volunteer
	...
	# Setter for voluntario_ferias of the member
	# @param param [Integer] The value you want to set
	def voluntario_ferias=(param)
		@voluntario_ferias = $enum_inscricao_especifica[param]
	end

	# Getter for projeto_especifico of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Category id of projeto_especifico of the member
	def projeto_especifico(index)
		i = get_field_index_by_external_id(index, @fields[:vaga_especifica])
		fields(index, i).to_s unless i.nil?
	end

	# Setter for projeto_especifico of the member
	# @param param [Integer] The value you want to set
	def projeto_especifico=(param)
		@projeto_especifico = param
	end

	# Getter for responsavel_id of the member
	# @param index [Integer] Index of the item you want to retrieve the value
	# @return [Integer] Id of referene of responsable of the member
	...
	# Setter for responsavel_id of the member
	# @param param [Integer] The value you want to set
	def responsavel_id=(param)
		@responsavel = param.to_i
	end

  # Getter for approached date of the member
  # @param index [Integer] Index of the item you want to retrieve the value
  # @return [String] Approached date of the member
  ...
  # Getter for dynamic date of the member
  # @param index [Integer] Index of the item you want to retrieve the value
  # @return [String] Dynamic date of the member
  ...
  # Getter for interview date of the member
  # @param index [Integer] Index of the item you want to retrieve the value
  # @return [String] interview date of the member
  ...
  def data_entrevista=(param)
	...
	def populate(entrevistado,i)
		self.nome_completo=(entrevistado.nome_completo(i))
    self.sexo=(entrevistado.sexo(i))
    self.data_nascimento=(entrevistado.data_nascimento(i))
    self.phones=(entrevistado.phones(i))
    self.telefone=(entrevistado.telefone(i))
    self.celular=(entrevistado.celular(i))
    self.operadora=(entrevistado.operadora(i))
    self.emails=(entrevistado.emails(i))
    self.email_text=(entrevistado.email_text(i))
    self.endereco=(entrevistado.endereco(i))
    self.cep=(entrevistado.cep(i))
    self.cidade=(entrevistado.cidade(i))
    self.estado_id=(entrevistado.estado_id(i))
    self.formacao=(entrevistado.formacao(i))
    self.curso=(entrevistado.curso(i))
    self.semestre=(entrevistado.semestre(i))
    self.faculdade=(entrevistado.faculdade(i))
    self.ingles=(entrevistado.ingles(i))
    self.espanhol=(entrevistado.espanhol(i))
    self.entidade=(entrevistado.entidade(i))
    self.turno=(entrevistado.turno(i))
    self.programa_interesse=(entrevistado.programa_interesse(i))
    self.conheceu_aiesec=(entrevistado.conheceu_aiesec(i))
    self.pessoa_que_indicou=(entrevistado.pessoa_que_indicou(i))
    self.voluntario_ferias=(entrevistado.voluntario_ferias?(i))
    self.projeto_especifico=(entrevistado.projeto_especifico(i))
    self.responsavel_id=(entrevistado.responsavel_id(i))
    self.data_abordagem=(entrevistado.data_abordagem(i))
    self.data_dinamica=(entrevistado.data_dinamica(i))
    self.data_entrevista=(entrevistado.data_entrevista(i))
	end
